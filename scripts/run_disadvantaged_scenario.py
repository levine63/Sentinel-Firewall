...
OUTPUT_DIR = ROOT / "outputs" / "disadvantaged_scenario_20260505"
...
def main():
    ...
    scenario_rows = []
    kitchen_disadv = model.simulate_kitchen(model.draw_params(seed=model.RNG_SEED))
    kohl_disadv = model.simulate_kohl(model.draw_params(seed=model.RNG_SEED + 2))
    scenario_rows.append(summarize_case(model, "Kitchen Disadvantaged Setting", kitchen_disadv))
    scenario_rows.append(summarize_case(model, "Kohl Disadvantaged Setting", kohl_disadv))
        ...
        [
            {
                ...
                "pct_change_bcr_cog_median": (
                    scenario.loc["Kitchen Disadvantaged Setting", "bcr_cog_median"]
                ...
                * 100,
                ...
                "pct_change_bcr_total_median": (
                    scenario.loc["Kitchen Disadvantaged Setting", "bcr_total_median"]
            ...
            },
            {
                ...
                "pct_change_bcr_cog_median": (
                    scenario.loc["Kohl Disadvantaged Setting", "bcr_cog_median"]
                ...
                * 100,
                ...
                "pct_change_bcr_total_median": (
                    scenario.loc["Kohl Disadvantaged Setting", "bcr_total_median"]
    ...
    print("Saved:")
    print(OUTPUT_DIR / "summary_table_with_disadvantaged_scenario.csv")
    print(OUTPUT_DIR / "disadvantaged_scenario_comparison.csv")
    print(OUTPUT_DIR / "disadvantaged_scenario_parameters.csv")
    print()
