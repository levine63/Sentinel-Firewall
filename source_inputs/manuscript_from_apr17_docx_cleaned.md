...
countries (LMICs). A growing share of exposure arises from informal
consumer products that are widely used but weakly regulated, including
artisanal cookware, traditional cosmetics and lead-contaminated
food-contact items. We propose a Sentinel Firewall framework which
identifies high-risk districts and deploys safe-product packages
customized to the hazards in that district. Distribution occurs during
existing contacts during pregnancy, birth and early childhood. We
evaluate two packages: a Kitchen Package consisting of a lead-safe pot
voucher, calcium and safe child utensils, and a Kohl Package consisting
of safe maternal and infant kohl substitutes. The model incorporates
district fixed costs, the duration of lead reduction from each new
product, maternal-fetal transfer of lead, and implementation issues from
imperfect targeting, imperfect health care fidelity, and failure to
exclusively use the new safe products. We use a 10 000-draw probabilistic
sensitivity analysis with PERT distributions to simulate reductions in
maternal and child blood lead levels, child cognitive gains, maternal
and neonatal health gains, adult cardiovascular health gains and income
gains. Both packages generate median benefit-cost ratios greater than 4, and the
5th percentile of the social benefit-cost ratio remains above parity in
both packages, largely due to the high costs of lead exposure. These findings support targeted pilot
implementation of safe-product substitution through maternal and child
health systems while stronger regulatory and industrial reforms are
pursued.
...
gasoline, many important residual exposures no longer arise mainly from
large, easily regulated formal industries. Instead, exposure often comes
from ordinary consumer products produced and distributed through
informal systems: artisanal cookware cast from mixed scrap, traditional
eye cosmetics such as kohl or surma, and ceramics or other food-contact
goods containing lead. WHO identifies cosmetics, ceramic glazes, toys,
traditional medicines, paint and contaminated food or water as
continuing sources of lead exposure, while recent rapid market screening
across 25 LMICs found frequent contamination in metal foodware,
ceramics, paints and cosmetics.2,3
...
lead-control strategy in many LMIC settings must identify local exposure
clusters and protect households during the period when developmental
harm is largest.
...
substitutes in high-risk districts, how large are the resulting social
gains relative to programme costs We answer that question by linking
each package to changes in blood lead, then translating those reductions
into child cognitive gains, maternal and neonatal health gains, and
adult cardiovascular gains (see Figure 1 for the main pathway –
cognitive gains).

![Figure 1. Simplified cognition pathway for the Kitchen Package. Safe pots, calcium and child utensils affect IQ and lifetime earnings only after targeting and implementation filters are applied.](../figures_main/figure_1_kitchen_cognition_pathway.png)
...
from birth using annual productivity, labour-force participation,
survival to adulthood and the end of working life, expected real income
growth and a social discount rate. To reflect wide uncertainty across
plausible LMIC settings, these macroeconomic inputs are assigned broad
ranges rather than point values: PPP GDP per capita ranges from US\$2000
to US\$8000 with a mode of US\$4000, labour-force participation ranges
from 0.40 to 0.70 with a mode of 0.55, real productivity growth has a
mode of 2%, and the social discount rate has a mode of 3%.12-14
...
0.0030-0.0100 per IQ point, with a mode of 0.0050. The lower bound
reflects LMIC evidence on cognition and wages and allows for substantial
labour-market friction in subsistence-heavy settings; the mode uses the
lower end of lead valuation estimates; and the upper bound is aligned
with developing-country cognitive-skill estimates while avoiding higher
US-based values.20-23
...
BLL reduction is modelled from 1 to 10 ug/dL, with a mode of 4. A full
...
self-targeting.27 We also include a residual-use penalty to reflect that
some unsafe pot use may continue even after redemption.
...
use gives a sense of the implementation attenuation we assume. The modal
assumptions imply that only a small share of the full-switcher
...
ratio (BCR_Cog) was 5.58, with a 5th to 95th percentile range of 1.97 to
15.20; 0.28% of simulated runs fell below parity.

The baseline Kitchen Package cost a median of US\$15.26 per mother-child
...
5.83, with a 5th to 95th percentile range of 2.13 to 15.56; 0.16% of
...
6.74, with a 5th to 95th percentile range of 2.57 to 17.34; 0.04% of
runs fell below parity.

The Kohl Package also appears cost-effective, but the case is less
...
was 4.66, with a 5th to 95th percentile range of 1.42 to 14.00; 1.69% of
runs fell below parity.

The baseline Kohl Package cost a median of US\$5.71 per mother-child
pair. It reduced child blood lead by a median of 0.80 ug/dL during the
...
mapping was 0.23 ug/dL. The median IQ gain was 0.08 points. The
corresponding median present value of lifetime earnings gain was
US\$27.25.

![Figure 2. Probabilistic sensitivity analysis of the Kitchen and Kohl packages. Distribution of cognition-channel benefit-cost ratios from 10 000 Monte Carlo draws, with a dashed line at parity.](../figures_main/figure_2_bcr_distribution.png)

Including maternal and neonatal benefits increased the median
benefit-cost ratio to 4.94, with a 5th to 95th percentile range of 1.59
to 14.43; 1.07% of runs fell below parity. Adding adult cardiovascular
benefits as a secondary extension increased the median total
benefit-cost ratio to 5.18, with a 5th to 95th percentile range of 1.71
to 14.94; 0.85% of runs fell below parity.
...
nonlinear IQ gains of about 0.60 for the Kitchen Package and 0.19 for
...
remains unchanged, the median cognition-only BCR is about 39% lower and
...
sentinel package is a large share of the total cost. If kohl were
...
The model suggests a credible social case for the Kitchen Package and a
more assumption-sensitive case for the Kohl Package. More broadly, the
analysis suggests that targeted safe-product substitution can generate
positive social returns in some settings. The magnitude and robustness
of those returns depend heavily on implementation quality, duration of
use, developmental timing and the magnitude of product-specific blood
lead reductions.
...
Thus, it is crucial that pilots be led by local investigators,
health-system actors and affected communities.
...
The model suggests that a program to replace lead-containing goods with
...
targeted to regions with high prevalence of the unsafe products.
...
Data are available in a public, open access repository. The full Python
simulation, including Monte Carlo uncertainty, parameter correlations,
plots and trial-level exports, is available at
https://faculty.haas.berkeley.edu/levine/lead/. A deterministic
spreadsheet with editable modal parameter values and live formulas is
available at
https://faculty.haas.berkeley.edu/levine/lead/simulating_sentinel_safe_products.xlsx.
...
Figure 1. Simplified cognition pathway for the Kitchen Package. Safe pots, calcium and child utensils affect IQ and lifetime earnings only after correct targeting, health-system contact, delivery fidelity and caregiver adherence are applied. Source file: `figure_1_kitchen_cognition_pathway.png`.

Figure 2. Probabilistic sensitivity analysis of the Kitchen and Kohl packages. Distribution of cognition-channel benefit-cost ratios from 10 000 Monte Carlo draws, with a dashed line at parity. Source file: `figure_2_bcr_distribution.png`.
...
13. International Labour Organization. ILOSTAT: labour force
    participation rate. 2024. Available: https://ilostat.ilo.org/data/
    \[Accessed 16 Apr 2026\].
